...
if missing_tables:
    raise RuntimeError(f"Missing required gold tables: {missing_tables}. Run one of the `pl_0100_orchestrate_capacity_consumption` Data Pipelines or manually run `0200 -> 0300 -> 0220/0230 -> 0300` first.")
