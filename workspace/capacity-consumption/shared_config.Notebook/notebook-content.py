...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "<capacity-metrics-lakehouse-id>",
# META       "default_lakehouse_name": "capacity_metrics",
# META       "default_lakehouse_workspace_id": "<target-workspace-id>",
# META       "known_lakehouses": [
# META         {
# META           "id": "<capacity-metrics-lakehouse-id>"
# META         }
# META       ]
# META     },
# META     "warehouse": {
...
# 
# **Usage:** Add `%run "./shared_config"` as the first code cell in each notebook.
...
# | DEFAULT_START_DATE_STR / DEFAULT_END_DATE_STR | Default shared collection window for pipeline collection tasks |
...
# - Referenced by the collection, transformation, and analysis notebooks.
...
# ==============================================================
METRIC_WORKSPACE_ID = "<capacity-metrics-workspace-id>"
METRIC_DATASET_ID   = "<capacity-metrics-semantic-model-id>"

# ==============================================================
# Default target capacity (override in any notebook parameter cell after %run)
# ==============================================================
TARGET_CAPACITY_ID  = "<target-capacity-id>"
...
# Gold tables -- curated outputs written by generate_gold_tables
