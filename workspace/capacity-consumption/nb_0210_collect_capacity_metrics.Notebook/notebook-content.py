...
# 
# ## Inputs
# - `nb_0110_shared_config` (loaded via `%run`) — all workspace/model/table config
...
# 
# ## Execution Order
# Run **before** `nb_0300_generate_gold_tables`.
# Run **independently** of `nb_0220_collect_timepoint_detail` / `nb_0240_collect_autoscale_timepoint_detail` (no data dependency between them).
# 
...
logger = logging.getLogger('nb_0200')
...
# Defaults come from nb_0110_shared_config; override here or via parent orchestration.
# ---------------------------------------------------------------------------
